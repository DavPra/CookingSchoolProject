...
<template>
  ...
  <div class="">
    ...
    <div class="mt-2 ">
      <v-sheet class="text-h6 font-weight-light text-center my-4 py-4 px-2 ">
      ...
      <!-- Location Part  -->
  <div>
    <v-sheet class="d-flex justify-start  flex-wrap align-center location" color="secondary">
      ...
      <!-- Kurs Part -->
      <div class="d-flex justify-start flex-wrap ma-6  align-center">
