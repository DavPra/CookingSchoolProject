...
<HeaderIcon/>
  ...
  <div class="">
    ...
    <v-container>
      <h1 class="text-h2 mt-10  header1"> Meet the Team </h1>
    </v-container>
    ...
    <div class=" ">
      ...
      <div class="d-flex justify-start ma-6  align-center">
        <v-sheet style="flex: 1;" class="pa-2 ma-3 text-h6 font-weight-light">
          <h1 class="text-h4 my-3 ">Unsere Mission </h1>
          ...
          <v-btn class="align-center mt-2 " variant="flat" color="primary" rounded @click = "goToCourses"> Unsere Kurse </v-btn>
    ...
    <v-sheet class=" mt-2 pa-4 " color="secondary">
      <h1 class="text-h4 mt-3 text-center text-black" >Die Crew </h1>
      <div class=" ma-2 py-5 text-h6 text-black font-weight-light text-center">
